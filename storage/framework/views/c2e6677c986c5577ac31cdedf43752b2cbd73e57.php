...
<div class="bg-light p-5 rounded">
        ...
        <table class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $konsumen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $konsum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e(date('d-m-Y', strtotime($konsum->Tanggal))); ?></td>
                    <td><?php echo e($konsum->Waktu); ?></td>
                    <td><?php echo e($konsum->Nama); ?></td>
                    <td><?php echo e($konsum->Email); ?></td>
                    <td><?php echo e($konsum->Number); ?></td>
                    <td><?php echo e($konsum->Message); ?></td>
                    <td class="text-nowrap"><form action="/konsumen/delete/<?php echo e($konsum->id); ?>" method="POST" class="d-inline">
                        <?php echo method_field('delete'); ?>
                        <?php echo csrf_field(); ?>
                        <a href="/konsumen/edit/<?php echo e($konsum->id); ?>" class="btn btn-success border-0"
                        >Edit
                    </a>
    ...
    <div class="jumbotron" id="home">
        <div class="container">
            <div class="text-center">
                <img src="<?php echo e(asset("images/Decorindo.svg")); ?>" class="rounded-circle img-thumbnail">
    ...
    <div id="service" class="service">
        ...
        <figure>
        <a href=<?php echo e(asset("images/bahan1.jpeg")); ?> class="fancybox" rel="ligthbox">
        <img src=<?php echo e(asset("images/bahan1.jpeg")); ?> class="zoom img-fluid" alt="">
        </a>
        <span class="hoverle">
        <a href=<?php echo e(asset("images/bahan1.jpeg")); ?> class="fancybox" rel="ligthbox">Multiplek</a>
        </span>
        </figure>
        </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md mb-4">
                    <div class="card">
                        <img class="card-img-top" src="<?php echo e(asset("images/images1.jpeg")); ?>" alt="Card image cap">
                        <div class="card-body">
                ...
                <div class="col-md mb-4">
                    <div class="card">
                        <img class="card-img-top" src="<?php echo e(asset("images/images2.jpg")); ?>" alt="Card image cap">
                        <div class="card-body">
                ...
                <div class="col-md mb-4">
                    <div class="card">
                        <img class="card-img-top" src="<?php echo e(asset("images/images3.jpg")); ?>" alt="Card image cap">
                        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md mb-4">
                    <div class="card">
                        <img class="card-img-top" src="<?php echo e(asset("images/images4.jpg")); ?>" alt="Card image cap">
                        <div class="card-body">
                ...
                <div class="col-md mb-4">
                    <div class="card">
                        <img class="card-img-top" src="<?php echo e(asset("images/images5.jpg")); ?>" alt="Card image cap">
                        <div class="card-body">
                ...
                <div class="col-md mb-4">
                    <div class="card">
                        <img class="card-img-top" src="<?php echo e(asset("images/images6.jpg")); ?>" alt="Card image cap">
                        <div class="card-body">
...
<?php echo $__env->make('layouts.app-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Praktek\login-and-registration\resources\views/home/index.blade.php ENDPATH**/ ?>