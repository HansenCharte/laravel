...
<?php $__env->startSection('content'); ?>
    <form method="post" action="<?php echo e(route('login.perform')); ?>">
        ...
        <img class="mb-4" src="<?php echo e(asset("images/Decorindo.svg")); ?>" alt="" width="72" height="57">
...
<?php echo $__env->make('layouts.auth-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Praktek\login-and-registration\resources\views/auth/login.blade.php ENDPATH**/ ?>